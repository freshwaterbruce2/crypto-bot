...
from src.monitoring.bot_integration import add_monitoring_to_bot, MonitoredKrakenTradingBot
from src.monitoring.monitoring_config import setup_monitoring_from_config, get_config_by_name
...
class MonitoredBotLauncher:
    ...
    def _display_monitoring_info(self):
        ...
        if status['dashboard_enabled']:
            ...
            print(f"📱 Mobile Friendly: Access from any device")
        else:
