...
class FallbackDataManager:
    ...
    async def _init_websocket(self):
        ...
        try:
            from .websocket_manager_v2 import KrakenProWebSocketManager
    ...
    async def _init_native_rest(self):
        ...
        try:
            ...
            if api_key and api_secret:
                ...
                logger.info("[FALLBACK] Native REST API fallback initialized")
            else:
                self.source_status[DataSource.NATIVE_REST] = False
                logger.warning("[FALLBACK] Native REST credentials missing")
