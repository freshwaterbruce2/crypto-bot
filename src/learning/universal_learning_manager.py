...
from src.utils.event_bus import EventBus, Event as BusEvent, EventType as BusEventType, get_event_bus
...
class UniversalLearningManager:
    ...
    def record_event(self, event_type: EventType, component: str, success: bool,
