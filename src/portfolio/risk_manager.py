...
from .position_tracker import Position, PositionTracker, PositionStatus
...
class RiskManager:
    ...
    async def calculate_optimal_position_size(self, symbol: str, price: float,
        ...
        try:
            ...
            recommended_size_units = recommended_size_usd / price
            
            # Conservative size (50% of recommended)
            conservative_size_usd = recommended_size_usd * 0.5
            conservative_size_units = conservative_size_usd / price
            ...
            aggressive_size_units = aggressive_size_usd / price
        ...
        if self.balance_manager:
            try:
                ...
                for asset, balance_data in balances.items():
                    total_value += balance_data.get('balance', 0)
