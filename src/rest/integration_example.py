...
from ..data.data_source_coordinator import DataSourceCoordinator, DataSource
...
class RestIntegrationExample:
    ...
    async def _demo_data_validation(self) -> None:
        ...
        try:
            ...
            logger.info(f"Balance validation result:")
    ...
    async def _demo_batch_operations(self) -> None:
        ...
        try:
            ...
            logger.info(f"Strategic client statistics:")
