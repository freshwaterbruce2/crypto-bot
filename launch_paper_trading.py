...
from src.paper_trading.paper_config import get_paper_config
...
class PaperTradingLauncher:
    ...
    def display_launch_summary(self):
        ...
        try:
            ...
            print("Trading Pair: SHIB/USDT")
            print("Position Size: $5-10 USD per trade")
            print("Max Concurrent Positions: 3")
            print("Daily Loss Limit: $20.00")
            print("Circuit Breaker: $30.00")
...
'''
    ...
    async def launch_bot(self):
        ...
        try:
            ...
            # Initialize bot
            bot = KrakenTradingBot(config=bot_config)
